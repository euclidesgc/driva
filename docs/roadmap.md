...
- `[-]` **42. Identidade visual: o ícone do app deixa de ser o do Flutter, e o nome próprio aparece.** _(pedido do humano, 2026-08-16; 0-dep)_ **Quick win priorizado pelo humano em 2026-08-16, para logo após o item 41 fechar.**
  ...
  - `[ ]` **O ícone — pendente, precisa de rascunho para aprovação antes dos PNGs finais.** `web/icons/` ainda tem os quatro PNGs do template Flutter (`Icon-192`, `Icon-512`, dois `maskable`) e o `favicon.png` também — **os dois manifests ainda apontam pro mesmo conjunto de ícones**, só o nome/texto já diverge entre editor e preview. Direção do humano: letras estilizadas, o **D** e o **B** de **Driva Builder**, algo artístico, moderno, com aspecto profissional. Decidir se os dois alvos instaláveis compartilham o ícone ou se diferenciam na tela inicial. **Próxima ação:** gerar 1-2 candidatos de monograma para aprovação do humano — é decisão estética, não técnica, então não entra direto como código.
