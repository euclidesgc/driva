...
**Contexto que carrega.** O pedido, as respostas do dev, as âncoras técnicas que o tech-lead devolveu e as specs anteriores em `docs/specs/` e `docs/NN-*/`. **Não carrega:** o código-fonte — quem abre código é o tech-lead.
...
**Formato do PRD** (template em `docs/NN-<nome>/`): resultado esperado, caminho feliz, exceções e casos de borda, o que vai para analytics, erros monitorados, e os testes que cada etapa vai pedir.
