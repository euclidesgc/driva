...
/// descendente — Tab nunca foca um campo do snapshot.
///
/// Renderiza o spec cru, sem o envoltório por nó que o mock editável usa
/// para injetar seleção e arraste, e sem despachante de eventos: nada aqui é
/// acionável, e soltar um widget da paleta sobre este lado não pode alterar
/// o rascunho.
